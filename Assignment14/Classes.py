# -*- coding: utf-8 -*-
"""
Created on Sat Apr 21 21:05:50 2026
...
# ============================================================
# SESSION 14: INHERITANCE EXAMPLE (Manager inherits Employee)
# ============================================================
...
class Manager(Employee):
    ...
    def calculate_bonus(self, performance_rating):
        # Logic: bonus increases with performance
        self.bonus = 1000 * performance_rating
        return self.bonus

    # -------- Method Overriding --------
    def get_position(self):
        # Override parent method
        return f"Manager - {self.position}"
...
def test_manager():
    print("\n================================================")
    print("SESSION 14 OUTPUT: MANAGER (INHERITANCE AND OVERRIDING)")
    print("================================================\n")

    # Instantiate Manager object
    mgr = Manager("Alice Brown", 11223, "Finance", "Director", 0)

    # Uses method from parrent class
    mgr.set_department("Corporate Finance")

    # Use new method from inherited class
    bonus = mgr.calculate_bonus(4.5)

    # Display data
    print(f"Name: {mgr.get_name()}")
    print(f"ID Number: {mgr.get_idNumber()}")
    print(f"Department: {mgr.get_department()}")
    print(f"Position (Overridden): {mgr.get_position()}")
